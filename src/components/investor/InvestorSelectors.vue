	...
	<el-card class="no-border project-selectors">
			...
			<el-col :span="22" :style="areaShowAll && 'max-height: 200px;'" class="project-checkbox-list">
				<el-row>
					<el-col :span="2" class="project-checkbox-item">
						<el-checkbox @change="clearCheckBox('area')" label="clear" v-model="areaClear">不限</el-checkbox>
					</el-col>
		...
		<el-row class="project-checkbox checkbox-round">
			...
			<el-col :span="22" :style="roundShowAll && 'max-height: 200px;'" class="project-checkbox-list">
				<el-row>
					<el-col :span="2" class="project-checkbox-item">
						<el-checkbox @change="clearCheckBox('round')" label="clear" v-model="roundClear">不限</el-checkbox>
					</el-col>
		...
		<el-row class="project-checkbox checkbox-round">
			...
			>
				<el-row>
					<el-col :span="2" class="project-checkbox-item">
						<el-checkbox @change="clearCheckBox('industry')" label="clear" v-model="industryClear">不限</el-checkbox>
					</el-col>
