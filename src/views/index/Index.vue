	...
	<div class="index">
		<el-row class="index-row">
			...
			<el-col :span="6" class="index-col-right">
				<div class="index-top_right-carousel">
					<el-carousel
				...
				<div class="index-users">
					<el-card class="no-border">
						...
						<ul v-if="authenticatedUsersList">
							<li :key="item.user_id" class="index-users-item" v-for="item in authenticatedUsersList">
								<el-row>
									<el-col :span="10">
...
export default {
	...
	computed: {
		...mapState({
			...
			recentProjectsList: state => state.index.recentProjectsList,
